...
describe User do
  ...
  describe 'with API authentication token' do
    it { user.api_authentication_token.should_not eql(nil) }
  end
  ...
  describe 'when email format is invalid' do
    it 'should be invalid' do
      addresses =
        %w(user@foo,com user_at_foo.org example.user@foo. foo@bar_baz.com foo@bar+baz.com user@foocom user@foo..com)
