...
describe Api::V1::UsersController, type: :request do
  ...
  context :index do
    ...
    describe 'authorized' do
      ...
      it 'returns the data in the body' do
        ...
        desire_keys = %w(id email name admin created_at updated_at)
  ...
  context :create do
    let(:data) do
      ActionController::Parameters.new('user' => { 'email' => 'example-@post.dom', 'name' => 'Kenna Rebiata',
    ...
    it 'new user created' do
      expect(User.find_by(email: data['user']['email'])).to_not eql(nil)
    end
  ...
  context :update do
    let(:new_data) do
      ActionController::Parameters.new('user' => { 'email' => 'updated@post.dom', 'name' => 'MD Newest Name',
        'password' => 'password', 'password_confirmation' => 'password' })
    end
    ...
    describe 'authorized' do
      ...
      describe 'with wrong credentials' do
        ...
        let(:wrong_data) do
          ActionController::Parameters.new('user' => { 'email' => 'wrong @ post.dom;', 'name' => 'MD Newest Name',
